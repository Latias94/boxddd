...
| Geometry resources | hull/mesh/height field/compound create/destroy helpers | Wrapped/Deferred | RAII constructors, hull clone/transform helpers, box scaling, arbitrary mesh creation, wave/torus/hollow/platform meshes, custom height fields, compound builders, compound child/material introspection, and compound child queries are wrapped. File-backed height fields and compound byte conversion stay raw/deferred. |
