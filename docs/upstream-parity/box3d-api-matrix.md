...
| Geometry resources | hull/mesh/height field/compound create/destroy helpers | Wrapped/Deferred | RAII constructors, hull clone/transform helpers, box scaling, arbitrary mesh creation, wave/torus/hollow/platform meshes, custom height fields, compound builders, and compound child/material introspection are wrapped. File-backed height fields, compound byte conversion, and compound overlap callbacks stay raw/deferred. |
