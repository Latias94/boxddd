...
| Body attached resources/events/queries | body shapes, joints, contacts, AABB, closest point, ray/shape overlap/casts, collide mover | Wrapped/Deferred | Shapes/joints/contacts/AABB are wrapped; body-local casts and collide-mover are partially deferred where no safe test surface exists yet. |
...
| Shape contacts/sensors/query helpers | `b3Shape_GetContactData`, `b3Shape_GetSensorData`, `b3Shape_RayCast`, closest point | Wrapped/Deferred | Contact/sensor/AABB/mass/geometry are wrapped; direct shape ray-cast/closest-point helpers are deferred. |
