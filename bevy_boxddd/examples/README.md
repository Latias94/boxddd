...
Current boxddd showcase entries: Query Lab, Debug Draw Inspector, and Material Lab. These routes teach Rust/Bevy integration patterns and are not counted as official Box3D sample ports.
